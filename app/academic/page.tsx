...
export default function AcademicPage() {
  ...
  const s1Cards = [
    ...
    },
    {
      ...
      link: "/academic/bachelor", // Redirect to main page for now as specific page is missing
      // onClick: () => handleBrochureClick("/images/brochure-bachelor.png"), // Removed modal behavior per request
    },
  ];
